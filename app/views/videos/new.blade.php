...
<script type="text/javascript">
    ...
    $(function() {
        ...
        //o.addMimeType("video/3gpp, video/3gpp2, video/x-msvideo, video/mp4, video/mpeg, video/x-flv, video/ogg, video/x-sgi-movie, video/x-ms-wmv, application/vnd.rn-realmedia");
        ...
        var uploader = new plupload.Uploader({
            ...
            url : '/videoupload',
            filters : [
                //{title : "Video files", extensions : "avi,mpeg,flv,mp4,ogg,mov,wmv,rm"}
            ]
