...
class UploadController extends BaseController {
    ...
    public function uploadVideo()
    {
        ...
        die('{"jsonrpc" : "2.0", "result" : null, "path" : "'.$filePath.'"}');
    }

    public function uploadToYoutube()
    {
        $inputs = Input::all();
        $path = $inputs['path'];
        ...
        $id = $youtubeClient->getVideoId();
        $url = $youtubeClient->getVideoUrl();
        $thumb = $youtubeClient->getVideoThumb();
        die('{"source" : "'.$url.'", "streaming" : "'.$url.'", "thumbnail" : "'.$thumb.'"}');
